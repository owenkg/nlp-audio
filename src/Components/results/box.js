...
const AudioCard = (props) => {
    ...
    return (
        <div className="col d-flex align-items-stretch mb-5 mb-lg-0">

            <div className="icon-box">
                <h2><i>{props.id}</i></h2>
                <div className="icon row">
                    <i className="bi-soundwave">
                        <h4 className="title">
                            <a href="">{props.name}</a>
                        </h4>
                    </i>
                ...
                <ListGroup className="list-group-flush" style={{ border: 'none' }}>
                    <ListGroupItem >
                        ...
                        <a href="#" className="collapse show" data-bs-target={`#one${props.id}`}>
                            Translate<i className="bx bx-chevron-down icon-show"></i>
                        </a>
                    ...
                    <ListGroupItem>
                        ...
                        <a href="#" className="collapse show" data-bs-target={`#two${props.id}`}>
                            Location<i className="bx bx-chevron-down icon-show"></i>
                        </a>
                    ...
                    <ListGroupItem>
                        <i className="bi-mic"></i> <a href="#" className="collapse show" data-bs-target={`#three${props.id}`}>Who's Speaking?<i className="bx bx-chevron-down icon-show"></i></a>
